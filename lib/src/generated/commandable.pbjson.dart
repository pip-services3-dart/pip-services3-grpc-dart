...
const ErrorDescription$json = const {
  ...
  '2': const [
    ...
    const {'1': 'details', '3': 8, '4': 3, '5': 11, '6': '.commandable.ErrorDescription.DetailsEntry', '10': 'details'},
  ],
...
const InvokeRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'correlation_id', '3': 2, '4': 1, '5': 9, '10': 'correlationId'},
...
const InvokeReply$json = const {
  '1': 'InvokeReply',
  '2': const [
    const {'1': 'error', '3': 1, '4': 1, '5': 11, '6': '.commandable.ErrorDescription', '10': 'error'},

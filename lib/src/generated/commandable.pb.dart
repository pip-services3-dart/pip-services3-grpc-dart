...
class ErrorDescription extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ErrorDescription', package: const $pb.PackageName('commandable'), createEmptyInstance: create)
    ..aOS(1, 'category')
    ..aOS(2, 'code')
    ..aOS(3, 'correlationId')
    ...
    ..aOS(6, 'cause')
    ..aOS(7, 'stackTrace')
    ..m<$core.String, $core.String>(8, 'details', entryClassName: 'ErrorDescription.DetailsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('commandable'))
...
class InvokeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InvokeRequest', package: const $pb.PackageName('commandable'), createEmptyInstance: create)
    ..aOS(1, 'method')
    ..aOS(2, 'correlationId')
    ..aOB(3, 'argsEmpty')
    ..aOS(4, 'argsJson')
  ...
  @$pb.TagNumber(2)
  set correlationId($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set argsEmpty($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set argsJson($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
...
class InvokeReply extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('InvokeReply', package: const $pb.PackageName('commandable'), createEmptyInstance: create)
  ...
  factory InvokeReply.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory InvokeReply.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  InvokeReply clone() => InvokeReply()..mergeFromMessage(this);
  InvokeReply copyWith(void Function(InvokeReply) updates) => super.copyWith((message) => updates(message as InvokeReply));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static InvokeReply getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<InvokeReply>(create);
  ...
  @$pb.TagNumber(2)
  set resultEmpty($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)

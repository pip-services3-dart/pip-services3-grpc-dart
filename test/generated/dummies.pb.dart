...
class ErrorDescription extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ErrorDescription', package: const $pb.PackageName('dummies'), createEmptyInstance: create)
    ..aOS(1, 'category')
    ..aOS(2, 'code')
    ..aOS(3, 'correlationId')
    ..aOS(4, 'status')
    ...
    ..aOS(6, 'cause')
    ..aOS(7, 'stackTrace')
    ..m<$core.String, $core.String>(8, 'details', entryClassName: 'ErrorDescription.DetailsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('dummies'))
...
class PagingParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PagingParams', package: const $pb.PackageName('dummies'), createEmptyInstance: create)
    ..aInt64(1, 'skip')
...
class Dummy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Dummy', package: const $pb.PackageName('dummies'), createEmptyInstance: create)
    ..aOS(1, 'id')
    ..aOS(2, 'key')
    ..aOS(3, 'content')
    ..hasRequiredFields = false
  ...
  Dummy copyWith(void Function(Dummy) updates) => super.copyWith((message) => updates(message as Dummy));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DummiesPage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DummiesPage', package: const $pb.PackageName('dummies'), createEmptyInstance: create)
    ..aInt64(1, 'total')
  ...
  DummiesPage copyWith(void Function(DummiesPage) updates) => super.copyWith((message) => updates(message as DummiesPage));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DummiesPageRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DummiesPageRequest', package: const $pb.PackageName('dummies'), createEmptyInstance: create)
    ..aOS(1, 'correlationId')
    ..m<$core.String, $core.String>(2, 'filter', entryClassName: 'DummiesPageRequest.FilterEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('dummies'))
  ...
  DummiesPageRequest copyWith(void Function(DummiesPageRequest) updates) => super.copyWith((message) => updates(message as DummiesPageRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DummyIdRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DummyIdRequest', package: const $pb.PackageName('dummies'), createEmptyInstance: create)
    ..aOS(1, 'correlationId')
    ..aOS(2, 'dummyId')
    ..hasRequiredFields = false
  ;
  ...
  DummyIdRequest copyWith(void Function(DummyIdRequest) updates) => super.copyWith((message) => updates(message as DummyIdRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DummyObjectRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DummyObjectRequest', package: const $pb.PackageName('dummies'), createEmptyInstance: create)
    ..aOS(1, 'correlationId')
  ...
  DummyObjectRequest copyWith(void Function(DummyObjectRequest) updates) => super.copyWith((message) => updates(message as DummyObjectRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

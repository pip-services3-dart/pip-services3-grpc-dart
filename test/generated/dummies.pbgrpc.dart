...
class DummiesClient extends $grpc.Client {
  ...
  DummiesClient($grpc.ClientChannel channel, {$grpc.CallOptions options})
  ...
  $grpc.ResponseFuture<$0.DummiesPage> get_dummies(
    ...
    final call = $createCall(
        _$get_dummies, $async.Stream.fromIterable([request]),
        options: options);
  ...
  $grpc.ResponseFuture<$0.Dummy> get_dummy_by_id($0.DummyIdRequest request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$get_dummy_by_id, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$0.Dummy> create_dummy($0.DummyObjectRequest request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$create_dummy, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$0.Dummy> update_dummy($0.DummyObjectRequest request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$update_dummy, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$0.Dummy> delete_dummy_by_id($0.DummyIdRequest request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$delete_dummy_by_id, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
}

...
final $typed_data.Uint8List errorDescriptionDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List dummyDescriptor = $convert.base64Decode('CgVEdW1teRIOCgJpZBgBIAEoCVICaWQSEAoDa2V5GAIgASgJUgNrZXkSGAoHY29udGVudBgDIAEoCVIHY29udGVudA==');
...
final $typed_data.Uint8List dummiesPageDescriptor = $convert.base64Decode('CgtEdW1taWVzUGFnZRIUCgV0b3RhbBgBIAEoA1IFdG90YWwSIgoEZGF0YRgCIAMoCzIOLmR1bW1pZXMuRHVtbXlSBGRhdGE=');
...
final $typed_data.Uint8List dummiesPageRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List dummyIdRequestDescriptor = $convert.base64Decode('Cg5EdW1teUlkUmVxdWVzdBIlCg5jb3JyZWxhdGlvbl9pZBgBIAEoCVINY29ycmVsYXRpb25JZBIZCghkdW1teV9pZBgCIAEoCVIHZHVtbXlJZA==');
...
final $typed_data.Uint8List dummyObjectRequestDescriptor = $convert.base64Decode('ChJEdW1teU9iamVjdFJlcXVlc3QSJQoOY29ycmVsYXRpb25faWQYASABKAlSDWNvcnJlbGF0aW9uSWQSJAoFZHVtbXkYAiABKAsyDi5kdW1taWVzLkR1bW15UgVkdW1teQ==');
